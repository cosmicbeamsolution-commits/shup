      ...
      <tiles>
        <card-component class="tile is-child">
          <form @submit.prevent="submit">
            ...
            <pre v-pre>
<strong>Podés usar estos bloques para invocar variables de la configuración de la tienda:</strong>
Fecha próxima entrega: {{formatted_next_delivery_date}}
Hora comienza entrega: {{hours_start}}
Hora finaliza entrega: {{hours_end}}
Costo del envío: {{delivery_cost}}
Precio mínimo del envío: {{min_price}}
Mensaje importante al pagar: {{text_customer_data_important}}
</pre>
            <hr>
