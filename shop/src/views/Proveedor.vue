                ...
                <div class="columns">
                  <div class="column">
                    ...
                    <b-field grouped position="is-right">
                      <b-field>
                        <b-button :label="data.base" type="is-info  is-outlined"/>
                      </b-field>
                      <b-field>
                        <router-link :to="'/consultar/' + data._id" class="button is-danger  is-outlined">
            ...
            <card-component v-show="!isLoading" class="animated delay-1s fadeIn">
              ...
              <form class="form" @submit.prevent="submit">
                ...
                <div class="has-text-centered">
                  <button type="submit" class="button is-danger  is-outlined" :class="{'is-loading' : isLoading}">
