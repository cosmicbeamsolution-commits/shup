      ...
      <div class="column is-hidden-desktop animated fadeIn">
        <div class="content">
          <card-component
            ...
            <div class="columns">
              <div class="column">
                <b-button @click="submit" type="is-danger is-fullwidth is-outlined is-rounded" title="Buscar en YA CABRÓN">Buscar</b-button>
              </div>
            </div>
            <div class="columns">
              <div class="column">
                <router-link to="/consultar" class="button is-fullwidth is-info is-outlined is-rounded" title="Solicitar presupuesto general">
        ...
        <card-component :is-float="true" :is-v-condensed="true">
          <div class="is-special-searchbox">
            <b-field grouped>
              ...
              <b-field>
                <b-button @click="submit" type="is-danger is-outlined is-rounded is-circle">
            ...
            <div class="column">
              <b-field grouped>
                ...
                <b-field v-show="filters.localidad">
                  <b-button @click="closeTab" type="is-primary is-small is-rounded is-outlined">
            ...
            <card-component class="animated delay-1s fadeIn">
              <div class="sidebar has-text-centered">
                ...
                <div class="has-text-centered">
                  <router-link to="/consultar" class="button is-info is-rounded is-outlined">
                    <span>Presupuesto múltiple</span>
                  </router-link>
                </div>
              </div>
