<template>
  <div>
    ...
    <hero-bar>
      <b-icon icon="account-star" size="is-medium"/>
      {{ heroTitle }}
      ...
      <card-component :title="formCardTitle" icon="account-star" class="tile is-child">
        <form @submit.prevent="submit">
          ...
          <b-field label="Nombre" horizontal>
            <b-input placeholder="ej: Juan" v-model="form.first_name" required />
          </b-field>
          <b-field label="Apellido" horizontal>
            <b-input placeholder="ej: Perez" v-model="form.last_name" required />
          </b-field>
          <b-field label="Email" horizontal>
            <b-input placeholder="ej: jperez@gmail.com" v-model="form.email" required />
          </b-field>
          <hr>
          <b-field horizontal>
